                ...
                <div className="flex max-w-md mx-auto flex-col text-center">
                    ...
                    <div className="mt-12 mb-8 p-8 bg-white rounded">
                        ...
                        >
                            ...
                            <option value="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..xiOJrWmHiz8tsPfLbwCrOuPud8h8Dn_5Y2NfZDnpwlQ">
                                Directora General: Gabriela Franco
                            </option>
                            <option value="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..7PQyU8CUdUZzYR8dwNdWA4P_SdQUuFher6BQpNJ2oV0">
