            ...
            <Page size="A4" style={styles.page}>
                ...
                <View style={styles.sectionContentTEXT} >
                    <View style={styles.sectionContentHEADERColumn}  >
                        <Svg id="Capa_1" height="80px"
                            viewBox="0 0 56.48 66.44"  >
                            <image width="85" height="100px" href="data:image/jpeg;base64,/9j/4AAQSkZJRgABAgEAbABsAAD/7AARRHVja3kAAQAEAAAAHgAA/+4AIUFkb2JlAGTAAAAAAQMA
...
E0Z37LqDt3WnPQmxLsXurJFEaRSejRkMo/8AIAH1/wAG/wDp17+P7648/wB669Pyf//Z" transform="matrix(0.6644 0 0 0.6644 0 0)">
                            </image>
                        </Svg>
                        ...
                        <Text style={styles.sectionH5} >Ministerio de Justicia y Derechos Humanos<br /></Text>
                        <Text style={styles.sectionH3}  >PROVINCIA DE SANTA FE <br />
                            REGISTRO GENERAL ROSARIO</Text>

                    </View>
                    
                    <View style={styles.sectionContentTEXTColumn}>
                        <View style={styles.sectionHeaderNoFlex}>
                            <Text style={styles.sectionH1}>MODULO Nº 1<br />
                                DOMINIO<br /></Text>
                            <Text style={styles.sectionH3}>SOLICITUD DE CERTIFICACION <br /></Text>
                            <Text>(Artículo 23 de la Ley Nacional 17.801) <br /></Text>
                            <Text style={styles.sectionH3}>SITUACION JURIDICA DEL INMUEBLE (DOMINIO Y SUS CONDICIONES) <br /></Text>
                            <Text>(Art. 39 al 43 y 47 Ley Provincial 6.435)</Text>
                        </View>
                ...
                <View style={styles.sectionFooter} >
                    <Text style={styles.sectionFooterBold}>TRATANDOSE DE FRACCION/ES DE UNA MAYOR AREA INSCRIPTA, DETERMINAR:
                    </Text>
                </View>
                ...
                <View style={styles.sectionContentTEXT} >
                    <View style={styles.sectionContentTEXTColumn}  >
                        <Text  >Dominio : <Text style={styles.sectionEtiqueta}></Text></Text>

                    </View>
                    <View style={styles.sectionContentTEXTColumn}  >
                        <Text  >Propiedad Horizontal:  <Text style={styles.sectionEtiqueta}>SI</Text></Text>

                    </View>
                    <View style={styles.sectionContentTEXTColumn}  >
                        <Text  >Departamento: <Text style={styles.sectionEtiqueta}></Text></Text>

                    </View>
                    <View style={styles.sectionContentTEXTColumn}  >
                        <Text  >Matricula:  <Text style={styles.sectionEtiqueta}>9098899</Text> </Text>
                ...
                <View style={styles.sectionContentTEXT} >
                    <View style={styles.sectionContentTEXTColumn}  >
                        <Text  >Distrito : <Text style={styles.sectionEtiqueta}>LOMAS DE ZAMORA</Text></Text>

                    </View>
                    <View style={styles.sectionContentTEXTColumn}  >
                        <Text  >Zona:  <Text style={styles.sectionEtiqueta}>LOMAS DE ZAMORA</Text></Text>

                    </View>
                    <View style={styles.sectionContentTEXTColumn}  >
                        <Text  >Localidad:  <Text style={styles.sectionEtiqueta}>LOMAS DE ZAMORA</Text></Text>
                ...
                <View style={styles.sectionContentTEXT} >
                    <View style={styles.sectionContentTEXTColumn}  >
                        <Text  >Calle :  <Text style={styles.sectionEtiqueta}>SANTOS CHOCANO</Text></Text>

                    </View>
                    <View style={styles.sectionContentTEXTColumn}  >
                        <Text  >Numero:  <Text style={styles.sectionEtiqueta}>345</Text></Text>

                    </View>
                    <View style={styles.sectionContentTEXTColumn}  >
                        <Text  >Entre calles: <Text style={styles.sectionEtiqueta}>VIENA Y ESTOCOLMO</Text></Text>
                ...
                <View style={styles.sectionContentTEXT} >
                    <View style={styles.sectionContentTEXTColumn}  >
                        <Text  >Lote : <Text style={styles.sectionEtiqueta}>5O</Text></Text>

                    </View>
                    <View style={styles.sectionContentTEXTColumn}  >
                        <Text  >Manzana: <Text style={styles.sectionEtiqueta}>345</Text></Text>

                    </View>
                    <View style={styles.sectionContentTEXTColumn}  >
                        <Text  >Superficie:  <Text style={styles.sectionEtiqueta}>VEC 3454</Text></Text>
                ...
                <View style={styles.sectionContentTEXT} >
                    ...
                    <View style={styles.sectionContentTEXTColumn}  >
                        <Text  >Plano:   <Text style={styles.sectionEtiqueta}>VEC 3454</Text></Text>

                    </View>
                    <View style={styles.sectionContentTEXTColumn}  >
                        <Text  >Año: <Text style={styles.sectionEtiqueta}>1983</Text></Text>

                    </View>
                    <View style={styles.sectionContentTEXTColumn}  >
                        <Text  >Arranque : <Text style={styles.sectionEtiqueta}>5O</Text></Text>
                ...
                <View style={styles.sectionFooter} >
                    <Text style={styles.sectionFooterBold}>RUMBOS, MEDIDAS LINEALES Y LINDEROS (Adaptar las iniciales a los rumbos si no coinciden con las aquí previstas):
                    </Text>
                </View>
                <View style={styles.sectionContentTEXT} >
                    <View style={styles.sectionContentTEXTColumn}  >
                        <Text  >NORTE : <Text style={styles.sectionEtiqueta}>5O</Text></Text>

                    </View>
                    <View style={styles.sectionContentTEXTColumn}  >
                        <Text  >SUR: <Text style={styles.sectionEtiqueta}>345</Text></Text>

                    </View>
                    <View style={styles.sectionContentTEXTColumn}  >
                        <Text  >ESTE:  <Text style={styles.sectionEtiqueta}>VEC 3454</Text></Text>

                    </View>
                    <View style={styles.sectionContentTEXTColumn}  >
                        <Text  >OESTE: <Text style={styles.sectionEtiqueta}>VEC 3454</Text></Text>

                    </View>
                </View>
                <View style={styles.sectionContentTEXT} >
                    <View style={styles.sectionContentTEXTColumn}  >
                        <Text  >NOROESTE:  <Text style={styles.sectionEtiqueta}>1983</Text></Text>

                    </View>
                    <View style={styles.sectionContentTEXTColumn}  >
                        <Text  >SUDOESTE:  <Text style={styles.sectionEtiqueta}>1983</Text></Text>

                    </View>
                    <View style={styles.sectionContentTEXTColumn}  >
                        <Text  >NORESTE: <Text style={styles.sectionEtiqueta}>1983</Text></Text>

                    </View>
                    <View style={styles.sectionContentTEXTColumn}  >
                        <Text  >SUDESTE: <Text style={styles.sectionEtiqueta}>1983</Text></Text>

                    </View>
                </View>
                <View style={styles.sectionFooter} >
                    <Text style={styles.sectionFooterBold}>Cuando es propiedad horizontal:
                    </Text>
                </View>
                <View style={styles.sectionContentTEXT} >
                    ...
                    <View style={styles.sectionContentTEXTColumn}  >
                        <Text  >Unidad:   <Text style={styles.sectionEtiqueta}>VEC 3454</Text></Text>

                    </View>
                    <View style={styles.sectionContentTEXTColumn}  >
                        <Text  >Parcela: <Text style={styles.sectionEtiqueta}>1983</Text></Text>

                    </View>
                    <View style={styles.sectionContentTEXTColumn}  >
                        <Text  >Planta : <Text style={styles.sectionEtiqueta}>5O</Text></Text>
                ...
                <View style={styles.sectionContentTEXT} >
                    ...
                    <View style={styles.sectionContentTEXTColumn}  >
                        <Text  >Comun: <Text style={styles.sectionEtiqueta}>1983</Text></Text>

                    </View>
                    <View style={styles.sectionContentTEXTColumn}  >
                        <Text  >Valor proporcional(%) : <Text style={styles.sectionEtiqueta}>5O</Text></Text>

                    </View>

                </View>
                <View style={styles.sectionContentTitle} >
                    <Text  >4. TITULAR / ES DE DOMINIO SEGUN TITULO INSCRIPTO PERSONA HUMANA</Text>
                </View>
                ...
                <View style={styles.sectionContentTable} >
                    ...
                    <View style={styles.sectionContentTableColumnBorder3}  >
                        <Text style={styles.sectionEtiquetaTable}>Apellido</Text>
                        <Text style={styles.description}>Leenen</Text>
                    </View>
                    <View style={styles.sectionContentTableColumnBorder3}  >
                        <Text style={styles.sectionEtiquetaTable}>Tipo y Nro Doc</Text>
                    ...
                    <View style={styles.sectionContentTableColumnBorderRigth}  >
                        <Text style={styles.sectionEtiquetaTable}>Fraccion</Text>
                        <Text style={styles.description}>4333344433</Text>
                    </View>
                </View>
                <View style={styles.sectionFooter} >
                ...
                <View style={styles.sectionContentTitle} >
                    <Text  >4. TITULAR / ES DE DOMINIO SEGUN TITULO INSCRIPTO PERSONA JURIDICA</Text>
                </View>
                ...
                <View style={styles.sectionContentTable} >
                    <View style={styles.sectionContentTableColumnBorder}  >
                        <Text style={styles.sectionEtiquetaTable}>Denominacion</Text>
                ...
                <View style={styles.sectionContentTEXT} >
                    <View style={styles.sectionContentTEXTColumn}  >
                        <Text  >Registro Nro : <Text style={styles.sectionEtiqueta}>342342</Text></Text>
                    ...
                    <View style={styles.sectionContentTEXTColumn}  >
                        <Text  >Provincia:  <Text style={styles.sectionEtiqueta}>Buenos Aires</Text></Text>
                ...
                <View style={styles.sectionContentTEXT} >
                    <View style={styles.sectionContentTEXTColumn}  >
                        <Text  >Domicilia : <Text style={styles.sectionEtiqueta}>Azara 342</Text></Text>

                    </View>
                    <View style={styles.sectionContentTEXTColumn}  >
                        <Text  >Telefono:  <Text style={styles.sectionEtiqueta}>+5411234566778</Text></Text>

                    </View>
                    <View style={styles.sectionContentTEXTColumn}  >
                        <Text  >  <Text style={styles.sectionEtiqueta}></Text></Text>
                ...
                <View style={styles.sectionContentTEXT} >
                    <View style={styles.sectionContentTEXTColumn}  >
                        <Text  >ANEXOS CONTINUANDO RUBRO / S Nº : <Text style={styles.sectionEtiqueta}>342342</Text></Text>
                ...
                <View style={styles.sectionContentTEXT} >
                    <View style={styles.sectionContentTEXTColumn}  >
                        <Text  >Observaciones : <Text style={styles.sectionEtiqueta}>342342</Text></Text>
                ...
                <View style={styles.sectionFirma} >
                    <Text style={styles.sectionFooterBold}>SIGNATURE: FIRMA ELECTRONICA
                    </Text>
                </View>
                <View style={styles.sectionFooter} >
                    <Text style={styles.sectionFooterBold}>PARA USO EXCLUSIVO DEL REGISTRO
                ...
                <View style={styles.sectionContentTEXT} >
                    <View style={styles.sectionContentTEXTColumn}  >
                        <Text  >La solicitud por causa  : <Text style={styles.sectionEtiqueta}>342342</Text></Text>
                ...
                <View style={styles.sectionContentTitle} >
                    <Text  >9. EL INMUEBLE DETERMINADO EN EL RUBRO 3 CONSTA A NOMBRE DE LA/S PERSONAS DETERMINADA/S EN EL RUBRO 4</Text>

                </View>

                <View style={styles.sectionContentTEXT} >
                    <View style={styles.sectionContentTEXTColumn}  >
                        <Text  >Solicitud Nro : <Text style={styles.sectionEtiqueta}>342342</Text></Text>

                    </View>
                    <View style={styles.sectionContentTEXTColumn}  >
                        <Text  >Fecha:  <Text style={styles.sectionEtiqueta}>21/12/2021</Text></Text>

                    </View>
                    <View style={styles.sectionContentTEXTColumn}  >
                        <Text  >Antecede:  <Text style={styles.sectionEtiqueta}>Buenos Aires</Text></Text>

                    </View>

                </View>
                <View style={styles.sectionContentTitle} >
                    <Text  >10. ADVERTENCIA: CERTIFICACIONES VIGENTES (con prioridad respecto de la presente: Art. 42 Ley 6435)</Text>
                ...
                <View style={styles.sectionContentTable} >
                    ...
                    <View style={styles.sectionContentTableColumnBorder3}  >
                        <Text style={styles.sectionEtiquetaTable}>Certificado</Text>
                        <Text style={styles.description}>1212</Text>
                    </View>
                    <View style={styles.sectionContentTableColumnBorder3}  >
                        <Text style={styles.sectionEtiquetaTable}>Operacion</Text>
                        <Text style={styles.description}>DU 4333344433</Text>
                    </View>
                    <View style={styles.sectionContentTableColumnBorderRigth}  >
                        <Text style={styles.sectionEtiquetaTable}>Escribano o Juzgado</Text>
                        <Text style={styles.description}>4333344433</Text>
                    </View>
                    <View style={styles.sectionContentTableColumnBorderRigth}  >
                    ...
                    <View style={styles.sectionContentTableColumnBorderRigth}  >
                        <Text style={styles.sectionEtiquetaTable}>Localidad</Text>
                        <Text style={styles.description}>4333344433</Text>
                    </View>
                    <View style={styles.sectionContentTableColumnBorderRigth}  >
                ...
                <View style={styles.sectionContentTitle} >
                    <Text  >11. POR EL INMUEBLE DETERMINADO EN LA SOLICITUD SE REGISTRA:</Text>

                </View>
                <View style={styles.sectionFooter} >
                    <Text style={styles.sectionFooterBold}>HIPOTECA - Inscripcion
                    </Text>
                </View>
                ...
                <View style={styles.sectionFooter} >
                    <Text style={styles.sectionFooterBold}>Escrituracion
                    </Text>
                </View>
                ...
                <View style={styles.sectionContentTable} >
                    ...
                    <View style={styles.sectionContentTableColumnBorder3}  >
                        <Text style={styles.sectionEtiquetaTable}>Registro</Text>
                        <Text style={styles.description}>1212</Text>
                    </View>
                    <View style={styles.sectionContentTableColumnBorder3}  >
                        <Text style={styles.sectionEtiquetaTable}>Localidad</Text>
                    ...
                    <View style={styles.sectionContentTableColumnBorder3}  >
                        <Text style={styles.sectionEtiquetaTable}>Escribano</Text>
                        <Text style={styles.description}>Leonardo G Leenen</Text>
                    </View>
                    <View style={styles.sectionContentTableColumnBorderRigth}  >
                ...
                <View style={styles.sectionFooter} >
                    <Text style={styles.sectionFooterBold}>Embargos
                    </Text>
                </View>
                ...
                <View style={styles.sectionContentTable} >
                    ...
                    <View style={styles.sectionContentTableColumnBorder3}  >
                        <Text style={styles.sectionEtiquetaTable}>Profesional que intervino</Text>
                        <Text style={styles.description}>Juan Manuel Caneva</Text>
                    </View>
                    <View style={styles.sectionContentTableColumnBorderRigth}  >
                        <Text style={styles.sectionEtiquetaTable}>Monto</Text>
                        <Text style={styles.description}></Text>
                ...
                <View style={styles.sectionContentTEXT} >
                    <View style={styles.sectionContentTEXTColumn}  >
                        <Text  >OTROS DERECHOS, MEDIDAS CAUTELARES, RESTRICCIONES Y AFECTACIONES U OTRAS CONSTANCIAS : <Text style={styles.sectionEtiqueta}>342342</Text></Text>
                ...
                <View style={styles.sectionContentTEXT} >
                    <View style={styles.sectionContentTEXTColumn}  >
                        <Text  >DESPACHO: El presente CERTIFICADO se expide a la cero (0) hora de la fecha de presentación de la solicitud y con el resultado
                            expresado en el/los RUBRO/S .........................................................................................................(Art. 40 y sgtes. Ley Provincial Nº 6435),
                            sobre la base de las referencias aportadas por el solicitante y a los efectos expresamente determinados por el mismo). </Text>
