        ...
        <div className="container px-4 mx-auto">
          <div className="max-w-2xl mx-auto text-center ">
            <div className="max-w-md mb-8 mx-auto prose">
              ...
              <h1 className="text-lg text-blueGray-400">Modulo N 1 Dominio</h1>
            </div>
            <div>
              <div className="">
                <div className="card  card shadow-lg">
                  <div className="card-body">
                    <h3 className="card-title" >1.Acto y Monto</h3>
                    <div className="mb-4">
                ...
                <section>
                  <div className="card  card shadow-lg mt-8">
                    <div className="card-body">
                      <h3 className="card-title" >2. Datos de inscripcion</h3>
                ...
                <section>
                  <div className="card  card shadow-lg mt-6">
                    <div className="card-body">
                      <h3 className="card-title" >3. Datos de Inmueble segun titulo inscripto</h3>
                      <div className="mb-4 flex">
                        <div className="form-control w-full">
                          <input
                            type="text"
                ...
                <section>
                  <div className="card  card shadow-lg mt-6">
                    <div className="card-body">
                      <h3 className="card-title" >4. Titular/es  de dominio segun titulo inscripto</h3>
