                ...
                <div className="container px-4 mx-auto">
                    <div className="max-w-xl mx-auto text-center">
                        ...
                        <p className="text-sm md:text-base text-white pt-8">
                            Tenemos un registro con su usuario para la empresa{' '}
                            <b>{state.companyInReview?.razonSocial}</b>. Dicha
                            solicitud se encuentra en proceso de revisión. Por
                            favor aguarde a ser contactado. Dicho contacto se
                            realizará por comunicación oficial al mail{' '}
                            <b>{state.companyInReview?.representante.email}</b>{' '}
                        ...
                        <p className="text-sm md:text-base text-white pt-8">
                            ...
                            spam ya que dicha respuesta pudo haber sido enviada
                            a esa carpeta
                        </p>
